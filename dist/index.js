...
program.on("--help", () => {
    ...
    console.log(chalk_1.default.gray("  $ ntic cache-info"));
    console.log(chalk_1.default.gray("    Monitor cache information\n"));
    console.log(chalk_1.default.gray("  $ ntic cache-clear"));
    console.log(chalk_1.default.gray("    Clear cached modules\n"));
});
// Error handling
